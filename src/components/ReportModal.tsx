...
export function ReportModal({ isOpen, onClose, onSubmit }: ReportModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4 backdrop-blur-sm">
      <div className="w-full max-w-md rounded-3xl border border-slate-200/80 bg-white/90 p-6 shadow-xl shadow-slate-200/60 dark:border-slate-700/80 dark:bg-slate-900/95 dark:shadow-black/40">
